...
plt.savefig("GDP_vs_Country.png")
plt.show()
...
plt.savefig("LEABY_vs_Country.png")
plt.show()
...
#GDP among the countries has more variation than life expectancy. NO, the two bar charts do not look similar.
...
plt.savefig("life_expectancy_GDP_violin.png")
plt.show()


# What do you notice about this distribution? Which country's life expactancy has changed the most?

#  #The distribution of life expactancy of most countries are close to each other, they do not vary a lot. Zimbabwe's life expactancy has changed the most.
...
#China's GDP bars and Zimbabwe's life expectancy change the most.
#2004~2009 years looks like the biggest changes in the data.
#Zimbabwe has had the least change in GDP over time.
#Life expectancy does not differ as much as GDP among the countries.
#GDP and life expectancy are not correlated as much among the developing and developed countries, but they seem correlated in Zimbabwe.
#In Zimbabwe, the lowest life expectancy is mainly because of the low economy, people's life standards are low and there are not enough essential life supporting conditions and facilities.
...
sns.set_palette("Set1")
plt.savefig("LEABY_GDP_scatter.png")
...
# IT's hard to tell.
# No.
# No, I don't think it' easy to read.
...
sns.set_palette("Set1")
plt.savefig("LEABY_Year_line.png")
...
#  #Zimbabwe's line changes the most.
#  #2005 to 2010 years are the biggest changes in the data.
#  #Mexico has had the least changes in life expectancy over time.
...
sns.set_palette("Set1")
plt.savefig("GDP_Year_lineplot.png")
...
#United States has the highest GDP and Zimbabwe has the lowest GDP.
...
#Chile and Germany have the highest life expectancy and Zimbabwe has the lowest life expectancy.
...
#China's open door policy since 1978, it is the continuous aftereffect, I think.
